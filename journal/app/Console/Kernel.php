...
//        $schedule->call('App\Http\Controllers\TestController@test',['params_type'=>1])->cron('0 0-23 * * *');
...
//        $schedule->call('App\Http\Controllers\XMLController@create_xml',['hours_xml'=>1])->cron('1 0-23 * * *');
...
//        $schedule->call('App\Http\Controllers\TestController@test',['params_type'=>1])->everyMinute();
