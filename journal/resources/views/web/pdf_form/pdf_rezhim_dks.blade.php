...
<div id="redirect">
    ...
    <h3 style="text-align: center">Режимы работы турбоагрегатов на ДКС-{{$dks}} Ямсовейского ГКМ за {{$date}}</h3>
    <div>
    ...
    <div style="margin-top: 5%">
        <span style="text-decoration:underline; margin-left: 65%; font-size: 20px">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; / &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</span>
    </div>
