...
@section('content')
    ...
    @endpush
        <div style="display: inline-flex; width: 100%">
            ...
            <h3 >Режимы работы турбоагрегатов на ДКС-{{$dks}} Ямсовейского ГКМ</h3>
    ...
    <div id="tableDiv" style="width: 100%">
        <table id="statickItemInfoTable" class="itemInfoTable" style="">
            ...
            <thead>
            <th colspan="24">20:00</th>
            </thead>
            <tbody id="data20">

            </tbody>
            <thead>
            <th colspan="24">00:00</th>
            </thead>
            <tbody id="data00">

            </tbody>
            <thead>
            <th colspan="24">04:00</th>
            </thead>
            <tbody id="data04">

            </tbody>
            <thead>
            <th colspan="24">08:00</th>
            </thead>
            <tbody id="data08">

            </tbody>
            <thead>
            <th colspan="24">12:00</th>
            </thead>
            <tbody id="data12">
