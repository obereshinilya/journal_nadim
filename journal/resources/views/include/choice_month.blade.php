<div class="date_div">
    ...
    <div class="date-input-group" id="stop-date-div">
        <input type="month" id="table_date_stop" class="date_input" required onkeydown="return false">
...
<script>
    ...
    $('#table_date_stop').val(today);

    document.getElementById("table_date_start").setAttribute("max", today);
    document.getElementById("table_date_stop").setAttribute("max", today);
