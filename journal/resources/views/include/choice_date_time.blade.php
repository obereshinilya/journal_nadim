<div class="date_div">
    ...
    <div class="date-input-group">
        <select class="date_input" id="select_interval">
    ...
    <div class="period-btns">
        <a class="choice-period-btn" id="submit_button">Отобразить</a>
        <a class="choice-period-btn" id="wait_button" style="display: none">Ожидайте...</a>
    </div>
